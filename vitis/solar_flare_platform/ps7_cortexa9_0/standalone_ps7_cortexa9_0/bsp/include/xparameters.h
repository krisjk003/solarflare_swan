...
#define XPAR_XCNN_FORWARD_NUM_INSTANCES 1

/* Definitions for peripheral CNN_FORWARD_0 */
#define XPAR_CNN_FORWARD_0_COMPATIBLE "xlnx,cnn-forward-1.0"
#define XPAR_CNN_FORWARD_0_BASEADDR 0x40000000
#define XPAR_CNN_FORWARD_0_HIGHADDR 0x4000ffff

/* Canonical definitions for peripheral CNN_FORWARD_0 */
#define XPAR_XCNN_FORWARD_0_BASEADDR 0x40000000
#define XPAR_XCNN_FORWARD_0_HIGHADDR 0x4000ffff
#define XPAR_XCNN_FORWARD_0_COMPATIBLE "xlnx,cnn-forward-1.0"
